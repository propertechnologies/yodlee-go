...
// AddedProviderAccountResponse AddedProviderAccountResponse
// swagger:model AddedProviderAccountResponse
...
func (m *AddedProviderAccountResponse) validateProviderAccount(formats strfmt.Registry) error {
...
func (m *AddedProviderAccountResponse) UnmarshalBinary(b []byte) error {
	var res AddedProviderAccountResponse
