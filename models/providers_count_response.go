...
// ProvidersCountResponse ProvidersCountResponse
// swagger:model ProvidersCountResponse
...
func (m *ProvidersCountResponse) validateProvider(formats strfmt.Registry) error {
...
func (m *ProvidersCountResponse) UnmarshalBinary(b []byte) error {
	var res ProvidersCountResponse
