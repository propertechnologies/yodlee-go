...
func (m *Holding) validateAccruedIncome(formats strfmt.Registry) error {
...
func (m *Holding) validateAccruedInterest(formats strfmt.Registry) error {
...
func (m *Holding) validateAssetClassification(formats strfmt.Registry) error {
...
func (m *Holding) validateCostBasis(formats strfmt.Registry) error {
...
var holdingTypeHoldingTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		holdingTypeHoldingTypePropEnum = append(holdingTypeHoldingTypePropEnum, v)
	}
}
...
// prop value enum
func (m *Holding) validateHoldingTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, holdingTypeHoldingTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *Holding) validateHoldingType(formats strfmt.Registry) error {
...
var holdingTypeOptionTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		holdingTypeOptionTypePropEnum = append(holdingTypeOptionTypePropEnum, v)
	}
}
...
// prop value enum
func (m *Holding) validateOptionTypeEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, holdingTypeOptionTypePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *Holding) validateOptionType(formats strfmt.Registry) error {
...
func (m *Holding) validatePrice(formats strfmt.Registry) error {
...
func (m *Holding) validateSpread(formats strfmt.Registry) error {
...
func (m *Holding) validateStrikePrice(formats strfmt.Registry) error {
...
func (m *Holding) validateUnvestedValue(formats strfmt.Registry) error {
...
func (m *Holding) validateValue(formats strfmt.Registry) error {
...
func (m *Holding) validateVestedValue(formats strfmt.Registry) error {
