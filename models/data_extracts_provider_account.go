...
// DataExtractsProviderAccount DataExtractsProviderAccount
// swagger:model DataExtractsProviderAccount
...
var dataExtractsProviderAccountTypeAggregationSourcePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		dataExtractsProviderAccountTypeAggregationSourcePropEnum = append(dataExtractsProviderAccountTypeAggregationSourcePropEnum, v)
	}
}
...
// prop value enum
func (m *DataExtractsProviderAccount) validateAggregationSourceEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, dataExtractsProviderAccountTypeAggregationSourcePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *DataExtractsProviderAccount) validateAggregationSource(formats strfmt.Registry) error {
...
func (m *DataExtractsProviderAccount) validateDataset(formats strfmt.Registry) error {
...
var dataExtractsProviderAccountTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		dataExtractsProviderAccountTypeStatusPropEnum = append(dataExtractsProviderAccountTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *DataExtractsProviderAccount) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, dataExtractsProviderAccountTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *DataExtractsProviderAccount) validateStatus(formats strfmt.Registry) error {
...
func (m *DataExtractsProviderAccount) UnmarshalBinary(b []byte) error {
	var res DataExtractsProviderAccount
