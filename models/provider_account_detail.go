...
// ProviderAccountDetail ProviderAccountDetail
// swagger:model ProviderAccountDetail
...
var providerAccountDetailTypeAggregationSourcePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		providerAccountDetailTypeAggregationSourcePropEnum = append(providerAccountDetailTypeAggregationSourcePropEnum, v)
	}
}
...
// prop value enum
func (m *ProviderAccountDetail) validateAggregationSourceEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, providerAccountDetailTypeAggregationSourcePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ProviderAccountDetail) validateAggregationSource(formats strfmt.Registry) error {
...
func (m *ProviderAccountDetail) validateDataset(formats strfmt.Registry) error {
...
func (m *ProviderAccountDetail) validateLoginForm(formats strfmt.Registry) error {
...
func (m *ProviderAccountDetail) validatePreferences(formats strfmt.Registry) error {
...
var providerAccountDetailTypeStatusPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		providerAccountDetailTypeStatusPropEnum = append(providerAccountDetailTypeStatusPropEnum, v)
	}
}
...
// prop value enum
func (m *ProviderAccountDetail) validateStatusEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, providerAccountDetailTypeStatusPropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ProviderAccountDetail) validateStatus(formats strfmt.Registry) error {
