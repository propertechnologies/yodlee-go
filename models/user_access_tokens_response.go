...
// UserAccessTokensResponse UserAccessTokensResponse
// swagger:model UserAccessTokensResponse
...
func (m *UserAccessTokensResponse) validateUser(formats strfmt.Registry) error {
...
func (m *UserAccessTokensResponse) UnmarshalBinary(b []byte) error {
	var res UserAccessTokensResponse
