...
// UpdatedProviderAccountResponse UpdatedProviderAccountResponse
// swagger:model UpdatedProviderAccountResponse
...
func (m *UpdatedProviderAccountResponse) validateProviderAccount(formats strfmt.Registry) error {
...
func (m *UpdatedProviderAccountResponse) UnmarshalBinary(b []byte) error {
	var res UpdatedProviderAccountResponse
