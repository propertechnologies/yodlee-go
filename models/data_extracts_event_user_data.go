...
// DataExtractsEventUserData DataExtractsEventUserData
// swagger:model DataExtractsEventUserData
...
func (m *DataExtractsEventUserData) validateLinks(formats strfmt.Registry) error {
...
func (m *DataExtractsEventUserData) validateUser(formats strfmt.Registry) error {
...
func (m *DataExtractsEventUserData) UnmarshalBinary(b []byte) error {
	var res DataExtractsEventUserData
